...
export const Dashboard = ({sidebar, setsidebar, page, setpage, components, setcomponents, utilities, setutilities}) => {
            ...
            <div className="card-body">
                ...
                <div className="progress">
                    <div className="progress-bar bg-success" role="progressbar" style={{
                        "width": "100%",
                        "aria-valuenow": "100", "aria-valuemin": "0", "aria-valuemax": "1}}00"
                    }}></div>
                </div>
            </div>
        </div>
